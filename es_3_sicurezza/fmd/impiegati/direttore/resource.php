...
$r = ldap_bind($conn, "cn=admin,dc=marius,dc=com", "admin") or die("Could not bind to server");     
// search for credentials
$result = ldap_search($conn,"cn=Altair Alighieri,dc=marius,dc=com", "(&(uid=".$name.")(userpassword=".$password."))");
